...
enum PublicSuffixType2 {
  ...
  private PublicSuffixType2(char innerNodeCode, char leafNodeCode) {
  ...
  /** Returns a PublicSuffixType2 of the right type according to the given code */
  static PublicSuffixType2 fromCode(char code) {
    for (PublicSuffixType2 value : values()) {
  ...
  static PublicSuffixType2 fromIsPrivate(boolean isPrivate) {
