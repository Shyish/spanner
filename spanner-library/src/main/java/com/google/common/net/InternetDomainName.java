...
import com.google.thirdparty.publicsuffix.PublicSuffixPatterns2;
...
public final class InternetDomainName {
  ...
  private int findPublicSuffix() {
    ...
    for (int i = 0; i < partsSize; i++) {
      ...
      if (PublicSuffixPatterns2.EXACT.containsKey(ancestorName)) {
        return i;
      }
      ...
      if (PublicSuffixPatterns2.EXCLUDED.containsKey(ancestorName)) {
        return i + 1;
      }
  ...
  private static boolean matchesWildcardPublicSuffix(String domain) {
    ...
    return pieces.length == 2 && PublicSuffixPatterns2.UNDER.containsKey(pieces[1]);
  }
